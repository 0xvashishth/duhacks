        ...
        <div className="HackathonTheme">
            ...
            <div class="wrapper">
                ...
                <div class="cards_wrap">
                    ...
                    <div class="card_item">
                        <div class="card_inner">
                            <img src="./images/open_inno.jpg" />
                            <div class="role_name">Open Innovation</div>
                            
                            <div class="film">Have any ideas that don't fit into any of the categories above? Worry \snot. The best aspect is that we encourage you to test your ideas and discover solutions to problems without any limitations.</div>
                        </div>
                    </div>
                    <div class="card_item">
                        <div class="card_inner">
                    ...
                    <div class="card_item">
                        <div class="card_inner">
                            <img src= "./images/health_care.jpg"/>
                    ...
                    <div class="card_item">
                        <div class="card_inner">
                            ...
                            <div class="film">Artificial intelligence is the intelligence demonstrated by computers as a result of their perception of their surroundings. Al-based devices are capable of taking independent actions in order to achieve a specific goal.</div>
                        </div>
                    </div>
                </div>
            </div>
